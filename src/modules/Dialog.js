...
export default function MyModal({ isOpen = false, setIsOpen, onSubmit, ...props }) {
  function closeModal() {
    setIsOpen(false)
  }
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-72 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                  ...
                  <div className="mt-4 text-right">
                    <button
                      ...
                      onClick={closeModal}
                    >
                      {props.dismissButtonText || "Dismiss"}
                    </button>
                    {onSubmit &&
                      <button
                        type="button"
